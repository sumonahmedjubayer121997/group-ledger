...
export const GroupBudgetManagement: React.FC<GroupBudgetManagementProps> = ({
    ...
    addBudget(
      {
        ...newBudget,
        type:
          newBudget.category === "overall" ? "group_overall" : "group_category",
        groupId: group.id,
        isActive: true,
      },
      user?.uid || "",
  ...
  const handleDeleteBudget = (budgetId: string) => {
    deleteBudget(budgetId, user?.uid || "", group.id);
    toast({
      title: "Success",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="budget-limit">
                    Budget Limit ({group.settings.currency})
                  </Label>
                  <Input
                    id="budget-limit"
                    type="number"
                          ...
                          {usage && (
                            <div className="space-y-2">
                              <div className="flex justify-between text-sm">
                                <span>
                                  Spent: {group.settings.currency}{" "}
                                  {usage.spent.toFixed(2)}
                                </span>
                                <span>
                                  Limit: {group.settings.currency}{" "}
